...
public final class ServerProtocol {
    ...
    // link
    public static final String LINK_TEMPLATE_VALIDATE_PATH = V2_API_VERSION + "/api/kakaolink/talk/template/validate";
    public static final String LINK_TEMPLATE_SCRAP_PATH = V2_API_VERSION + "/api/kakaolink/talk/template/scrap";
