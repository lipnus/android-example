...
public class ChatListContext extends PageableContext {
    ...
    @Deprecated
    private ChatListContext(ChatType chatType, int fromId, int limit, String order) {
    ...
    @Deprecated
    public static ChatListContext createContext(final ChatType chatType, final int fromId, final int limit, final String order) {
        return new ChatListContext(chatType, fromId, limit, order);
    }
