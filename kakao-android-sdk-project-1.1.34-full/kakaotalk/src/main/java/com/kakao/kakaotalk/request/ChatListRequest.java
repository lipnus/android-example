 ...
 * {@link ChatRoomListRequest}으로 대체된다.
 */
@Deprecated
public class ChatListRequest extends ApiRequest {
    ...
    public String getUrl() {
        ...
        String url = ApiRequest.createBaseURL(ServerProtocol.API_AUTHORITY, ServerProtocol.TALK_CHAT_LIST_PATH);
        QueryString qs = new QueryString();
        qs.add(StringSet.chat_type, chatType);
