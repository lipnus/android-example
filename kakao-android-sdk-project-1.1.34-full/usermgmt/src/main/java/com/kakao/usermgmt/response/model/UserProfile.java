...
public class UserProfile implements User, Parcelable {
     ...
     */
    public UserProfile(ResponseBody body) throws ResponseBodyException {
        ...
        if (body.has(StringSet.properties)) {
            this.properties = body.toMap(body.getBody(StringSet.properties));
    ...
    public String toString() {
        ...
        sb.append(", code='").append(uuid).append('\'');
        sb.append(", serviceUserId='").append(serviceUserId).append('\'');
        sb.append(", remainingInviteCount='").append(remainingInviteCount).append('\'');
        sb.append(", remainingGroupMsgCount='").append(remainingGroupMsgCount).append('\'');
