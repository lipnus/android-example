...
import com.kakao.sdk.sample.common.widget.KakaoSpinnerAdapter;
...
public class KakaoTalkChatListActivity extends BaseActivity implements IChatListCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatType = (KakaoDialogSpinner)findViewById(R.id.chat_type);
        chatListView = (ListView)findViewById(R.id.chat_list);
        requestChatLists();

        chatType.setOnListener(new KakaoSpinnerAdapter.ISpinnerListener() {
            @Override
    ...
    private void requestChatListInner() {
        ...
        KakaoTalkService.requestChatRoomList(new KakaoTalkChatListResponseCallback<ChatListResponse>() {
            @Override
