...
public class CommentListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String updateTime = SimpleFunction.timeGap( rc.getComment_updated_at() ); //현재시간과의 차이
        ...
        profileIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                iT.putExtra("nickname", rc.getComment_user_nickname() );
                iT.putExtra("image_path", rc.getComment_user_image() );
                ...
                new SweetAlertDialog(context, SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                ...
                                cmActivity.connect_delete( rc.getComment_no() );
