...
import com.asha.md360player4android.Other.BitmapPlayerActivity;
import com.asha.md360player4android.Other.CubemapPlayerActivity;
import com.asha.md360player4android.Other.CustomProjectionFactory;
import com.asha.md360player4android.Other.HoverView;
import com.asha.md360player4android.Other.SpinnerHelper;
import com.asha.md360player4android.Other.VideoPlayerActivity;
 ...
 */
public abstract class SeatSelect extends Activity implements SurfaceHolder.Callback{

    private static final String TAG = "SeatSelect";
    ...
    static public MDVRLibrary mVRLibrary;
    ...
    Button btn;
    static public ImageView backgroundIv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        backgroundIv = (ImageView) findViewById(R.id.seat_back_iv);
        Glide.with(this)
                .load(R.drawable.before)
                .into(backgroundIv);

        Toast.makeText(this, "원하시는 좌석을 터치해 주세요", Toast.LENGTH_SHORT).show();
    }

    public void onClick_seat2(View v){
        Glide.with(this)
                .load(R.drawable.after)
                .into(backgroundIv);
    }
...
//        surfaceDestroyed(surfaceHolder);
    ...
    //스피너들 처리하기 귀찮아서 여기 처박아놓고 invisible
    public void spinnerSet(){
        ...
        SpinnerHelper.with(this)
                ...
                .setClickHandler(new SpinnerHelper.ClickHandler() {
                    ...
                    public void onSpinnerClicked(int index, int key, String value) {
                        mVRLibrary.switchDisplayMode(SeatSelect.this, key);
                        int i = 0;
                        ...
                        Log.d("SSSS", "sDisplayMode Key: " + key);
                    }
                })
        ...
        SpinnerHelper.with(this)
                ...
                .setClickHandler(new SpinnerHelper.ClickHandler() {
                    @Override
                    public void onSpinnerClicked(int index, int key, String value) {
                        mVRLibrary.switchInteractiveMode(SeatSelect.this, key);

                        Log.d("SSSS", "sInteractiveMode key: " + key);
                    }
                })
        ...
        SpinnerHelper.with(this)
                ...
                .setClickHandler(new SpinnerHelper.ClickHandler() {
                    @Override
                    public void onSpinnerClicked(int index, int key, String value) {
                        mVRLibrary.switchProjectionMode(SeatSelect.this, key);
                    }
                })
        ...
        findViewById(R.id.button_add_plugin).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SeatSelect.this, "add plugin position:" + position, Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                MDHotspotBuilder builder = MDHotspotBuilder.create(mImageLoadProvider)
                        ...
                        .listenClick(new MDVRLibrary.ITouchPickListener() {
                            @Override
                            public void onHotspotHit(IMDHotspot hitHotspot, MDRay ray) {
                                Toast.makeText(SeatSelect.this, "click logo", Toast.LENGTH_SHORT).show();
                            }
                        });
                MDAbsHotspot hotspot = new MDSimpleHotspot(builder);
                plugins.add(hotspot);
                getVRLibrary().addPlugin(hotspot);
                Toast.makeText(SeatSelect.this, "add plugin logo" , Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.seat);
