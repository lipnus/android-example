 ...
 */
public class BitmapPlayerActivity extends SeatSelect {
    ...
    //영상 실행
    public void onClick_seat(View v){

        Log.d("SSSS", "onClick_seat");

        SeatSelect.mVRLibrary.switchInteractiveMode(this, 3);
        busy();
        nextUri = getDrawableUri(R.drawable.cgv4);
        getVRLibrary().notifyPlayerChanged();


        Glide.with(this)
                .load(R.drawable.after)
                .into( SeatSelect.backgroundIv );
    }
